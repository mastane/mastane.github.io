...
* (actually, the negative sign in front of the KL is bad news for the proof of gradient descent...check out my paper to see how to solve that issue, by considering a reweighted version of the gradient)
